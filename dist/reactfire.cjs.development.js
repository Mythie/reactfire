...
function useUser(options) {
  ...
  var _options = (_options2 = _extends({}, options)) != null ? _options2 : {}; // only set/override initialData if auth has finished loading


  if (auth$1.currentUser !== undefined) {
    _options.initialData = auth$1.currentUser;
    _options.startWithValue = auth$1.currentUser;
  }
